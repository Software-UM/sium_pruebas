        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <form role="form" method="POST" class="form-horizontal"
                      action="{{url("/modules/escolar/grupos/modify")}}" enctype="multipart/form-data">
                    <input type="hidden" name="_token" value="{{ csrf_token() }}"/>
                    <input type="hidden" name="idGrupo" id="idGrupo" value="{{$grupo->getId()}}">
                        ...
                        <div class="col-sm-5">
                            <select id="modalidad" name="modalidad" class="form-control input-sm">
                                @foreach($modalidad as $mod)
                                    @if($grupo->getIdModalidad() == $mod->id)

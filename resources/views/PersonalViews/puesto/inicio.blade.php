...
@section('menuLateral')
    <li class="treeview">
        <a href="{{ url('admin') }}">
            <i class="fa fa-area-chart"></i> <span>Admin panel</span></i>
        </a>
    </li>
    <li class="treeview active">
        ...
        <ul class="treeview-menu">
            ...
            <li class="active"><a href="{{ url('modules/personal/puesto') }}"><i class="fa fa-arrow-circle-right"></i> Puestos</a></li>
        </ul>
    </li>
    <li class="treeview">
        <a href="#">
            ...
            <div class="box-body">
                ...
                <div class="col-md-12">
                    ...
                    <div class="col-md-offset-2 col-sm-3 pull-right">
                        <div class="input-group">
                            <a class="btn btn-block btn-social btn-bitbucket"
                               href="{{url('/modules/personal/puesto/add')}}">
                    ...
                    <table id="tablaGrupos" class="table table-bordered table-hover table-striped"
                        ...
                        <tr>
                            <th width="5">#</th>
                            <th class="col-md-3 col-xs-3">Descripcion</th>
                            ...
                            <tr id={{ $puesto->id}}>
                                ...
                                <td>
                                    <a class="btn btn-danger" title="Eliminar tipo empleado"
                                       onclick="setValue('{{ $puesto->id }}','{{$puesto->descripcion}}',this)"><i
                                                class="fa fa-trash fa-lg"></i></a>
                                    <a href="{{url("/modules/personal/puesto/")}}/modify/{{$puesto->id}}"
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Eliminar Registro Puesto</h4>
                </div>
                <div class="modal-body">
                    <p>¿Deseas Eliminar el Puesto?</p>

    ...
    <section class="content">
        <div class="box box-primary">
            <div class="box-header">
                <h3 class="box-title">Nuevo Tipo Horario</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                @if(session('mensaje'))
                ...
                <div class="col-md-12">
                    <form role="form" method="POST" class="form-horizontal"
                          action="{{ url('/modules/personal/horario/tipo/add') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group col-sm-12 {{ $errors->has('antes') ? ' has-error' : '' }}">
                            ...
                            <div class="col-sm-5">
                                <input type="number" id="antes" name="antes" class="form-control" value="0"/>
                                @if ($errors->has('antes'))
                                    <p class="help-block">
                        ...
                        <div class="form-group col-sm-12 {{ $errors->has('despues') ? ' has-error' : '' }}">
                            ...
                            <div class="col-sm-5">
                                <input type="number" id="despues" name="despues" class="form-control" value="0"/>

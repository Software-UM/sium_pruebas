        ...
        <div class="box box-primary">
            <div class="box-header">
                <h3 class="box-title">Gestión de Departamentos
                    <small>Modificar Departamento</small>
                </h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                ...
                <form role="form" method="POST" class="form-horizontal"
                      action="{{url("/modules/personal/departamento/modify")}}" enctype="multipart/form-data">
                    <input type="hidden" name="_token" value="{{ csrf_token() }}"/>
                    <input type="hidden" name="idDepa" value="{{$departamento->getId()}}"/>
                    ...
                    <div class="form-group {{ $errors->has('descripcion') ? ' has-error' : '' }}">
                        ...
                        <div class="col-sm-5">
                            <textarea style="overflow:auto;resize:none" class="form-control" name="descripcion"
                                      id="descripcion"
                            >{{$departamento->getDescripcion()}}</textarea>
